...
// Process packet based off packet tyep
...
// Gets a file from the server by sending a a packet with the file name
...
// Sends packets from manager queue to the server
